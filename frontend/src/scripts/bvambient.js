  ...
  constructor({
    ...
    this.MoveParticle = function (element) {
      ...
      function SetFrame() {
        ...
        if (isresting == 1) {
          var RandomTransitionTime =
            Math.floor(
              Math.random() * (max_transition_speed - min_transition_speed + 1),
          ...
          if (d_v == "down" && d_h == "left") {
            ...
            element.style.top =
              rect_main.offsetHeight - Number(element_width) + "px";
            isresting = 0;
          }
    ...
    this.SetupParticles = function (number) {
      ...
      for (var i = 1; i <= resp_particles; i++) {
        ...
        var bvparticle = document.getElementById(
        ...
        // Get random number based on the width and height of main div
        var RandomTopPosition =
          Math.floor(Math.random() * (widthMainDiv.offsetHeight - 40 + 1)) + 0;
        var RandomLeftPosition =
          Math.floor(Math.random() * (widthMainDiv.offsetWidth - 100 + 1)) + 0;

        // Get random number based on the width and height of main div
        var RandomWidth =
          Math.random() * (this.particle_maxwidth - this.particle_minwidth) +
