      ...
      <Card className='mb-4'>
          <div className="flex p-3 items-center justify-between overflow-hidden">
              <div className="flex items-center">
                  <div className={`bg-[url(${profile.avatar})] border-2 ${profile.online ? "border-green-500" : "border-white"} bg-cover bg-center bg-no-repeat rounded-full w-14 aspect-square`} />
              ...
              </div>
              {
                  request ?
                  <div className="flex">                
                      <button onClick={() => handleClick('accept')} className="aspect-square w-7 h-7 flex items-center justify-center rounded-full border hover:border-green-600 border-green-500">
                          <i className="fa-solid fa-check text-lg text-green-500 hover:text-green-600 cursor-pointer"></i>
                      </button>
                      <button onClick={() => handleClick('deny')} className="aspect-square w-7 h-7 flex items-center justify-center rounded-full border hover:border-red-600 border-red-500 ml-2">
