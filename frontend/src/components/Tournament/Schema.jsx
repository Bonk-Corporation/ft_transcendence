      ...
      (props.room.size == 2 && props.room.phases.length == 2) ? (
        <div className="flex flex-col items-center">
          ...
          <div className="h-full flex justify-center">
            <div
              className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[3][0].avatar})]`}
            ></div>
          </div>
        </div>
      ) : null}
          ...
          (props.room.size == 2 && props.room.phases.length >= 1) ? (
            <div className="flex justify-center">
              <div className="w-48 h-full flex justify-center pl-1">
                <div
                  className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[2][0].avatar})]`}
                ></div>
              </div>
              <div className="w-48 h-full flex justify-center"></div>
              <div className="w-48 h-full flex justify-center pr-1">
                <div
                  className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[2][1].avatar})]`}
                ></div>
              </div>
            </div>
          ) : null}
          ...
          (props.room.size == 4 && props.room.phases.length >= 1) ? (
            <div className="flex justify-center">
              <div className="w-24 h-full flex justify-center pl-1">
                <div
                  className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[1][0].avatar})]`}
                ></div>
              </div>
              <div className="w-24 h-full flex justify-center"></div>
              <div className="w-24 h-full flex justify-center pr-1">
                <div
                  className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[1][1].avatar})]`}
                ></div>
              </div>
              <div className="w-24 h-full flex justify-center"></div>
              <div className="w-24 h-full flex justify-center pl-1">
                <div
                  className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[1][2].avatar})]`}
                ></div>
              </div>
              <div className="w-24 h-full flex justify-center"></div>
              <div className="w-24 h-full flex justify-center pr-1">
                <div
                  className={`h-8 aspect-square rounded-full border-4 bg-center bg-cover bg-[url(${props.room.phases[1][3].avatar})]`}
                ></div>
              </div>
            </div>
          ) : null}
