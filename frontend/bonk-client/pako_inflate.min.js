...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : t(
          ((e =
            "undefined" != typeof globalThis ? globalThis : e || self).pako =
            {}),
        );
})(this, function (e) {
  "use strict";
  ...
  const a = 16209;
  var r = function (e, t) {
    let i, n, r, o, s, l, d, f, c, h, u, w, b, m, k, _, g, p, v, x, y, E, R, A;
    const Z = e.state;
    (i = e.next_in),
      (R = e.input),
      (n = i + (e.avail_in - 5)),
  ...
  var c = (e, t, i, n, a, r, c, h) => {
      ...
      if ((E > y && (E = y), 0 === y))
        return (a[r++] = 20971520), (a[r++] = 20971520), (h.bits = 1), 0;
      for (x = 1; x < y && 0 === U[x]; x++);
  ...
  const K = (e) => {
      if (j) {
        ...
        for (c(1, e.lens, 0, 288, M, 0, e.work, { bits: 9 }), t = 0; t < 32; )
          e.lens[t++] = 5;
  ...
  var Y = {
    ...
    inflate: (e, i) => {
      ...
      e: for (;;)
        switch (a.mode) {
          ...
          case 16185:
            if (
              ...
              L &&
                ...
                512 & a.flags && 4 & a.wrap && (a.check = n(a.check, o, L, l)),
                (f -= L),
                (l += L),
                (a.length -= L)),
              a.length)
          ...
          case 16193:
            ...
            if (
              ((a.length = 65535 & B), (B = 0), (C = 0), (a.mode = S), i === b)
            )
              break e;
          case S:
            a.mode = 16195;
          case 16195:
            if (((L = a.length), L)) {
              if ((L > f && (L = f), L > h && (L = h), 0 === L)) break e;
          ...
          case 16198:
            ...
            if (
              ...
              (ee = { bits: a.distbits }),
              (Q = c(2, a.lens, a.nlen, a.ndist, a.distcode, 0, a.work, ee)),
              (a.distbits = ee.bits),
              Q)
            ) {
          ...
          case O:
            ...
            if (
              ((B >>>= j), (C -= j), (a.back += j), (a.length = G), 0 === Y)
            ) {
              a.mode = 16205;
              break;
            }
      ...
      return (
        ...
        (a.bits = C),
        (a.wsize ||
          (F !== e.avail_out && a.mode < D && (a.mode < U || i !== u))) &&
    ...
    inflateSetDictionary: (e, i) => {
      ...
      return N(e)
        ...
        : ((a = e.state),
          0 !== a.wrap && a.mode !== R
            ? g
            : a.mode === R && ((r = 1), (r = t(r, i, n, 0)), r !== a.check)
              ? p
              : ((o = P(e, i, n, n)),
  ...
  function he(e) {
    this.options = X({ chunkSize: 65536, windowBits: 15, to: "" }, e || {});
    ...
    if (
      ...
      t.dictionary &&
        ...
        t.raw &&
          ((i = Y.inflateSetDictionary(this.strm, t.dictionary)), i !== oe)))
    )
  ...
  (he.prototype.push = function (e, t) {
    ...
    for (
      ...
      for (
        0 === i.avail_out &&
          ((i.output = new Uint8Array(n)), (i.next_out = 0), (i.avail_out = n)),
          r = Y.inflate(i, o),
          r === le &&
            a &&
            ((r = Y.inflateSetDictionary(i, a)),
            r === oe ? (r = Y.inflate(i, o)) : r === fe && (r = le));
        i.avail_in > 0 && r === se && i.state.wrap > 0 && 0 !== e[i.next_in];
      ...
      if (((s = i.avail_out), i.next_out && (0 === i.avail_out || r === se)))
      ...
      if (r !== oe || 0 !== s) {
        if (r === se)
          return (
            (r = Y.inflateEnd(this.strm)), this.onEnd(r), (this.ended = !0), !0
          );
