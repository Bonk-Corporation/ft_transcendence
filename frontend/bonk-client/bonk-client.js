...
const InternalConfig = function (initConfig) {
  ...
  Config.prototype.getModuleConfig = function (loadPath, response) {
    ...
    return {
      ...
      noExitRuntime: false,
      dynamicLibraries: [`/static/${loadPath}.side.wasm`],
      ...
      locateFile: function (path) {
        if (!path.startsWith("godot.")) {
          ...
          return `/static/${loadPath}.worker.js`;
        } else if (path.endsWith(".audio.worklet.js")) {
          return `/static/${loadPath}.audio.worklet.js`;
        } else if (path.endsWith(".js")) {
          return `/static/${loadPath}.js`;
        } else if (path.endsWith(".side.wasm")) {
          return `/static/${loadPath}.side.wasm`;
        } else if (path.endsWith(".wasm")) {
          return `/static/${loadPath}.wasm`;
        }
        return path;
      },
    };
...
const Engine = (function () {
  ...
  Engine.load = function (basePath, size) {
    if (loadPromise == null) {
      loadPath = basePath;
      loadPromise = preloader.loadPromise(
        `/static/${loadPath}.wasm`,
        size,
        true,
      );
    ...
    const proto = /** @lends Engine.prototype */ {
      ...
      init: function (basePath) {
        ...
        if (loadPromise == null) {
          ...
          Engine.load(
            basePath,
            this.config.fileSizes[`/static/${basePath}.wasm`],
          );
        }
        const me = this;
      ...
      startGame: function (override) {
        ...
        const pack = this.config.mainPack || `/static/${exe}.pck`;
